...
def enhance_pipeline_combined(image: np.ndarray) -> np.ndarray:
    ...
    fully_enhanced = apply_clahe(color_corrected, clip_limit=2.0, tile_size=(8, 8))
    return fully_enhanced

def process_dataset_combined(input_dir: str, output_dir: str):
    """
    Percorre a estrutura do dataset YOLO, processa as imagens com a
    abordagem combinada e copia as labels.
    """
    ...
    for split in splits:
        ...
        print(f"[Combinado] Processando {len(img_files)} imagens em: {split}")
...
if __name__ == "__main__":
    ...
    DATASET_ORIGINAL = "/home/Cake/Documentos/UFRB/TCC/yolo_testes_subpipe/yolo_dataset"
    DATASET_SAIDA = "/home/Cake/Documentos/UFRB/TCC/yolo_testes_subpipe/yolo_dataset_enhanced"
